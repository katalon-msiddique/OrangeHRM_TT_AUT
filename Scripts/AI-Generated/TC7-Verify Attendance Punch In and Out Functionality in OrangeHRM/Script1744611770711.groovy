...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 2-Click on link time.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 3-Click on i attendance.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 4-Click on link punchInOut.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 5-Enter input value in textarea typeHere.png')

"Step 6: Click on button in -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'web/index.php/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_dynamic_content/button_in'))

WebUI.takeScreenshot(reportLocation + '/TC7/Step 6-Click on button in - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Verify Attendance Punch In and Out Functionality in OrangeHRM_visual_checkpoint')
